...
def combine_videos(
    ...
    for i, video_path in enumerate(video_paths):
        try:
            ...
            logger.warning(f"Cannot process video {video_path}. Remove the video")
            video_paths[i] = ""

    video_paths = [vpath for vpath in video_paths if vpath]
...
def generate_video(
    ...
    def create_text_clip(subtitle_item):
        ...
        if params.subtitle_position == "bottom":
            ...
            custom_y = max(min_y, min(custom_y, max_y))  # Constrain the y value within the valid range
    ...
    logger.info(f"Using background music: {bgm_file if bgm_file else None}")
...
if __name__ == "__main__":
    # generate_video(
    #     video_path="/Users/duynm/duynm/me/playground/daily-space-news/output.mp4",
    #     audio_path="/Users/duynm/duynm/me/playground/daily-space-news/test.mp3",
    #     subtitle_path="/Users/duynm/duynm/me/playground/daily-space-news/test.mp3.srt",
    ...
    combine_videos(
        "test.mp4",
        glob.glob(os.path.join("output/7af206a4-dd92-44f2-9c24-ce2ebada0e3c/videos", "*")),
        audio_file="output/7af206a4-dd92-44f2-9c24-ce2ebada0e3c/audio.mp3",

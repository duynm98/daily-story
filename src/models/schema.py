...
class VideoParams(BaseModel):
    ...
    # video_terms: Optional[str] = None  # Keywords used to generate the video
    ...
    # voice_volume: Optional[float] = config["video"].get("voice_volume", 1.0)
...
#                     "combined_videos": ["http://127.0.0.1:8080/tasks/6c85c8cc-a77a-42b9-bc30-947815aa0558/combined-1.mp4"],
#                 },
#             },
#         }
